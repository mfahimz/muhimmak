...
import { PendingClosuresClient, type PendingClosureItem } from "./PendingClosuresClient";

export const dynamic = "force-dynamic";

export default async function PendingClosuresPage() {
  ...
  const t = await getTranslations("PendingClosures");

  // Fetch all visit_closures rows with session and resolver profile info
