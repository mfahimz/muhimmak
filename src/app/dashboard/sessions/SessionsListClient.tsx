...
export function SessionsListClient({
  ...
  return (
    <div className="space-y-6">
      {/* Tab Switcher */}
      <div className="flex bg-muted p-1 rounded-2xl border border-border w-fit font-semibold text-xs">
        <button
          type="button"
        ...
        >
          ...
          {closures.length > 0 && (
            <span className="inline-flex items-center justify-center px-1.5 py-0.5 text-[10px] font-bold rounded-full bg-amber-100 dark:bg-amber-950/60 text-amber-700 dark:text-amber-300">
